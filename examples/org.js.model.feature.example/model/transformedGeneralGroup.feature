...
<feature:FeatureModel xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:feature="http://www.tudresden.de/extfeature">
  <root id="root" name="root" selected="unbound">
    ...
    <groups id="root_g2" minCardinality="1" maxCardinality="1">
      <childFeatures id="f1_f2" name="f1_f2" selected="unbound"/>
      <childFeatures id="f1_f3" name="f1_f3" selected="unbound"/>
      <childFeatures id="f2_f3" name="f2_f3" selected="unbound"/>
    </groups>
  </root>
