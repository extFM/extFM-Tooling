...
<feature:FeatureModel xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:feature="http://www.tudresden.de/extfeature" name="16">
  <root id="root" name="root">
    ...
    <groups id="1" minCardinality="1" maxCardinality="8">
