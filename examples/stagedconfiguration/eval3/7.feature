...
<feature:FeatureModel xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:feature="http://www.tudresden.de/extfeature" name="7">
  <root id="root" name="root">
    <groups id="1" minCardinality="1" maxCardinality="1">
      <childFeatures id="F1" name="F1">
        ...
        <groups id="1" minCardinality="1" maxCardinality="3">
          ...
          <childFeatures id="F9" name="F9">
            ...
            <groups id="1" minCardinality="1" maxCardinality="4">
