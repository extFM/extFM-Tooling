...
import sedaj.FMtoPtNet;
import sedaj.util.FMUtil;
import sedaj.util.GroupDefinition;

/**
 * Implementation of the interface {@link FMtoPtNet}. 
 * Transforms a {@link FeatureModel} to a {@link PtNet}. 
...
public class FmtoPtNetImpl implements FMtoPtNet {
	...
	/**
	 * Creates a {@link PtNet} with a start and end {@link Place}.
	 * Adds a {@link Transition} for the root {@link Feature}. 
