...
/**
 * This is the item provider adapter for a {@link org.js.graph.graphtransformation.AddNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddNodeItemProvider
	...
	protected void addNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AddNode_node_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AddNode_node_feature", "_UI_AddNode_type"),
				 GraphtransformationPackage.Literals.ADD_NODE__NODE,
				 false,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphtransformationPackage.Literals.ADD_NODE__NODE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AddNode.class)) {
			case GraphtransformationPackage.ADD_NODE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case GraphtransformationPackage.ADD_NODE__NODE:
