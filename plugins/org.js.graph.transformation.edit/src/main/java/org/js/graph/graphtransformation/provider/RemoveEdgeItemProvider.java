...
/**
 * This is the item provider adapter for a {@link org.js.graph.graphtransformation.RemoveEdge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RemoveEdgeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphtransformationPackage.Literals.REMOVE_EDGE__EDGE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RemoveEdge.class)) {
			case GraphtransformationPackage.REMOVE_EDGE__NAME:
