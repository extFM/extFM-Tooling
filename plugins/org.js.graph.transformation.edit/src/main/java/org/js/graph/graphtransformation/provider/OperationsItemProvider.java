...
/**
 * This is the item provider adapter for a {@link org.js.graph.graphtransformation.Operations} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationsItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphtransformationPackage.Literals.OPERATIONS__CHANGE_PRIMITIVES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphtransformationPackage.Literals.OPERATIONS__CHANGE_PRIMITIVES,
				 GraphtransformationFactory.eINSTANCE.createRemoveNode()));

		newChildDescriptors.add
			(createChildParameter
				(GraphtransformationPackage.Literals.OPERATIONS__CHANGE_PRIMITIVES,
				 GraphtransformationFactory.eINSTANCE.createRemoveEdge()));

		newChildDescriptors.add
			(createChildParameter
				(GraphtransformationPackage.Literals.OPERATIONS__CHANGE_PRIMITIVES,
				 GraphtransformationFactory.eINSTANCE.createAddEdge()));

		newChildDescriptors.add
			(createChildParameter
				(GraphtransformationPackage.Literals.OPERATIONS__CHANGE_PRIMITIVES,
				 GraphtransformationFactory.eINSTANCE.createAddNode()));
	}
