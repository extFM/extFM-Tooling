...
/**
 * This is the item provider adapter for a {@link org.js.graph.graphtransformation.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphtransformationPackage.Literals.RULE__LEFTSIDE);
			childrenFeatures.add(GraphtransformationPackage.Literals.RULE__ROLES);
			childrenFeatures.add(GraphtransformationPackage.Literals.RULE__APPLICATION_CONDITIONS);
			childrenFeatures.add(GraphtransformationPackage.Literals.RULE__OPERATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphtransformationPackage.Literals.RULE__LEFTSIDE,
				 GraphtransformationFactory.eINSTANCE.createLeftSide()));

		newChildDescriptors.add
			(createChildParameter
				(GraphtransformationPackage.Literals.RULE__ROLES,
				 GraphtransformationFactory.eINSTANCE.createRoles()));

		newChildDescriptors.add
			(createChildParameter
				(GraphtransformationPackage.Literals.RULE__APPLICATION_CONDITIONS,
				 GraphtransformationFactory.eINSTANCE.createApplicationConditions()));

		newChildDescriptors.add
			(createChildParameter
				(GraphtransformationPackage.Literals.RULE__OPERATIONS,
				 GraphtransformationFactory.eINSTANCE.createOperations()));
	}
