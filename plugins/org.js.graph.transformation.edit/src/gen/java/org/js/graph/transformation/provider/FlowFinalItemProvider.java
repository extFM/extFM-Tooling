...
/**
 * This is the item provider adapter for a {@link org.js.graph.transformation.FlowFinal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowFinalItemProvider
    ...
    * @generated
    */
	public FlowFinalItemProvider(AdapterFactory adapterFactory) {
    ...
    */
	...
	public Object getImage(Object object) {
      return overlayImage(object, getResourceLocator().getImage("full/obj16/FlowFinal"));
   }
    ...
    */
	...
	public String getText(Object object) {
      String label = ((FlowFinal)object).getName();
      return label == null || label.length() == 0 ?
         getString("_UI_FlowFinal_type") :
         getString("_UI_FlowFinal_type") + " " + label;
   }
    ...
    */
	...
	public void notifyChanged(Notification notification) {
      ...
      switch (notification.getFeatureID(FlowFinal.class)) {
