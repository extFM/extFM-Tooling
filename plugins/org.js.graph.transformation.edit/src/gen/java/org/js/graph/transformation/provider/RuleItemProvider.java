...
/**
 * This is the item provider adapter for a {@link org.js.graph.transformation.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    */
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
      if (childrenFeatures == null) {
         ...
         childrenFeatures.add(TransformationPackage.Literals.RULE__LEFTSIDE);
         childrenFeatures.add(TransformationPackage.Literals.RULE__ROLES);
         childrenFeatures.add(TransformationPackage.Literals.RULE__APPLICATION_CONDITIONS);
         childrenFeatures.add(TransformationPackage.Literals.RULE__OPERATIONS);
      }
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
      ...
      newChildDescriptors.add
         (createChildParameter
            (TransformationPackage.Literals.RULE__LEFTSIDE,
             TransformationFactory.eINSTANCE.createLeftSide()));

      newChildDescriptors.add
         (createChildParameter
            (TransformationPackage.Literals.RULE__ROLES,
             TransformationFactory.eINSTANCE.createRoles()));

      newChildDescriptors.add
         (createChildParameter
            (TransformationPackage.Literals.RULE__APPLICATION_CONDITIONS,
             TransformationFactory.eINSTANCE.createApplicationConditions()));

      newChildDescriptors.add
         (createChildParameter
            (TransformationPackage.Literals.RULE__OPERATIONS,
             TransformationFactory.eINSTANCE.createOperations()));
   }
