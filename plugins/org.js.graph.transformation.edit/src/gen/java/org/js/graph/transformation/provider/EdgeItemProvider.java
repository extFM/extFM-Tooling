...
/**
 * This is the item provider adapter for a {@link org.js.graph.transformation.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TransformationPackage.Literals.EDGE__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TransformationPackage.Literals.EDGE__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		if (((Edge) object).getSource() != null) {
			source = ((Edge) object).getSource().getName();
		}
		if (((Edge) object).getTarget() != null) {
			target = ((Edge) object).getTarget().getName();
		}
		if (source == null)
			source = "";
		if (target == null)
