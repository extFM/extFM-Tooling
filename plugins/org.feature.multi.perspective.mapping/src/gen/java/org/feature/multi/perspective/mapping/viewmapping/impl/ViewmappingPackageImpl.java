...
public class ViewmappingPackageImpl extends EPackageImpl implements ViewmappingPackage {
   ...
   */
   public void initializePackageContents() {
    ...
    initEReference(getMapping_Features(), theFeaturePackage.getFeature(), null, "features", null, 1, -1, Mapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
