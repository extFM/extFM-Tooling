 ...
 * 
 */
public abstract class AbstractFeatureModelConstraint extends AbstractModelConstraint implements IModelConstraint {
      ...
      /**
       * validate the eObject that issued the constraint check.
       * @param target
       * @return
       */
