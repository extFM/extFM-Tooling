...
/**
 * This is the item provider adapter for a {@link org.feature.multi.perspective.mapping.viewmapping.MappingModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MappingModelItemProvider
      ...
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_MappingModel_featureModel_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_MappingModel_featureModel_feature", "_UI_MappingModel_type"),
             ViewmappingPackage.Literals.MAPPING_MODEL__FEATURE_MODEL,
             true,
             false,
             true,
             null,
   ...
   protected void addViewModelPropertyDescriptor(Object object) {
      itemPropertyDescriptors.add
         (createItemPropertyDescriptor
            (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
             getResourceLocator(),
             getString("_UI_MappingModel_viewModel_feature"),
             getString("_UI_PropertyDescriptor_description", "_UI_MappingModel_viewModel_feature", "_UI_MappingModel_type"),
             ViewmappingPackage.Literals.MAPPING_MODEL__VIEW_MODEL,
             true,
             false,
             true,
             null,
   ...
   public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
      if (childrenFeatures == null) {
         ...
         childrenFeatures.add(ViewmappingPackage.Literals.MAPPING_MODEL__MAPPINGS);
      }
   ...
   public String getText(Object object) {
      return getString("_UI_MappingModel_type");
   }
   ...
   protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
      ...
      newChildDescriptors.add
         (createChildParameter
            (ViewmappingPackage.Literals.MAPPING_MODEL__MAPPINGS,
             ViewmappingFactory.eINSTANCE.createMapping()));
   }
