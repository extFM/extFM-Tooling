 ...
 * <ul>
 *   <li>{@link org.js.graph.graphtransformation.impl.AddEdgeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.js.graph.graphtransformation.impl.AddEdgeImpl#getEdge <em>Edge</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AddEdgeImpl extends EObjectImpl implements AddEdge {
	/**
	...
	protected EClass eStaticClass() {
		return GraphtransformationPackage.Literals.ADD_EDGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphtransformationPackage.ADD_EDGE__NAME, oldName, name));
	}
	...
	public EList<ActivityEdge> getEdge() {
		if (edge == null) {
			edge = new EObjectContainmentEList<ActivityEdge>(ActivityEdge.class, this, GraphtransformationPackage.ADD_EDGE__EDGE);
		}
		return edge;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GraphtransformationPackage.ADD_EDGE__EDGE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphtransformationPackage.ADD_EDGE__NAME:
				return getName();
			case GraphtransformationPackage.ADD_EDGE__EDGE:
				return getEdge();
		}
