 ...
 * <ul>
 *   <li>{@link org.js.graph.graphtransformation.impl.ExistingRoleImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.js.graph.graphtransformation.impl.ExistingRoleImpl#getAcion <em>Acion</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExistingRoleImpl extends EObjectImpl implements ExistingRole {
	/**
	...
	protected EClass eStaticClass() {
		return GraphtransformationPackage.Literals.EXISTING_ROLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphtransformationPackage.EXISTING_ROLE__NAME, oldName, name));
	}
	...
	public SpecializationAction getAcion() {
		if (acion != null && acion.eIsProxy()) {
			...
			if (acion != oldAcion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GraphtransformationPackage.EXISTING_ROLE__ACION, oldAcion, acion));
			}
		}
		return acion;
	}
	...
	public NotificationChain basicSetAcion(SpecializationAction newAcion, NotificationChain msgs) {
		...
		acion = newAcion;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GraphtransformationPackage.EXISTING_ROLE__ACION, oldAcion, newAcion);
	...
	public void setAcion(SpecializationAction newAcion) {
		if (newAcion != acion) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GraphtransformationPackage.EXISTING_ROLE__ACION, newAcion, newAcion));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GraphtransformationPackage.EXISTING_ROLE__ACION:
				if (acion != null)
					msgs = ((InternalEObject)acion).eInverseRemove(this, GraphtransformationPackage.SPECIALIZATION_ACTION__VARIABLE_ROLE, SpecializationAction.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphtransformationPackage.EXISTING_ROLE__NAME:
				return getName();
			case GraphtransformationPackage.EXISTING_ROLE__ACION:
