 ...
 * <ul>
 *   <li>{@link org.js.graph.graphtransformation.impl.ForkNodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.js.graph.graphtransformation.impl.ForkNodeImpl#getIn <em>In</em>}</li>
 *   <li>{@link org.js.graph.graphtransformation.impl.ForkNodeImpl#getOut <em>Out</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForkNodeImpl extends EObjectImpl implements ForkNode {
	...
	protected EClass eStaticClass() {
		return GraphtransformationPackage.Literals.FORK_NODE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphtransformationPackage.FORK_NODE__NAME, oldName, name));
	}
	...
	public EList<ActivityEdge> getIn() {
		if (in == null) {
			in = new EObjectWithInverseResolvingEList<ActivityEdge>(ActivityEdge.class, this, GraphtransformationPackage.FORK_NODE__IN, GraphtransformationPackage.ACTIVITY_EDGE__TARGET);
		}
		return in;
	}
	...
	public EList<ActivityEdge> getOut() {
		if (out == null) {
			out = new EObjectWithInverseResolvingEList<ActivityEdge>(ActivityEdge.class, this, GraphtransformationPackage.FORK_NODE__OUT, GraphtransformationPackage.ACTIVITY_EDGE__SOURCE);
		}
		return out;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GraphtransformationPackage.FORK_NODE__IN:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIn()).basicAdd(otherEnd, msgs);
			case GraphtransformationPackage.FORK_NODE__OUT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphtransformationPackage.FORK_NODE__NAME:
				return getName();
			case GraphtransformationPackage.FORK_NODE__IN:
				return getIn();
			case GraphtransformationPackage.FORK_NODE__OUT:
