...
public interface WorkflowPackage extends EPackage {
    ...
    */
	...
	/**
    * The feature id for the '<em><b>Configuration Operations</b></em>' reference list.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int LOG__CONFIGURATION_OPERATIONS = ConfPackage.ASPECT_INSTANCE_FEATURE_COUNT + 0;
    ...
    */
	...
	/**
    * Returns the meta object for the reference list '{@link org.js.model.workflow.Log#getConfigurationOperations <em>Configuration Operations</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference list '<em>Configuration Operations</em>'.
    * @see org.js.model.workflow.Log#getConfigurationOperations()
    * @see #getLog()
    * @generated
    */
   EReference getLog_ConfigurationOperations();
    ...
    */
	interface Literals {
       ...
       */
		...
		/**
       * The meta object literal for the '<em><b>Configuration Operations</b></em>' reference list feature.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */
      EReference LOG__CONFIGURATION_OPERATIONS = eINSTANCE.getLog_ConfigurationOperations();
