 ...
 */
public class ExpressionPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.emftext.term.propositional.expression.resource.expression";
	/**
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, ExpressionPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, ExpressionPlugin.PLUGIN_ID, message);
		}
		final ExpressionPlugin pluginInstance = ExpressionPlugin.getDefault();
