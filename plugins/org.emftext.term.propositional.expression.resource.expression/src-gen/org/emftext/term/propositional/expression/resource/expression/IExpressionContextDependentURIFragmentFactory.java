 ...
 * org.emftext.term.propositional.expression.resource.expression.IExpressionContext
 * DependentURIFragment.
 * 
 * @param <ContainerType> the type of the class containing the reference to be
 * resolved
 * @param <ReferenceType> the type of the reference to be resolved
 */
public interface IExpressionContextDependentURIFragmentFactory<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> {
	
	/**
	 * Create a new instance of the
	 * org.emftext.term.propositional.expression.resource.expression.IExpressionContext
	 * DependentURIFragment interface.
	 * 
