...
public class ExpressionNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.term.propositional.expression.resource.expression.nature";
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
