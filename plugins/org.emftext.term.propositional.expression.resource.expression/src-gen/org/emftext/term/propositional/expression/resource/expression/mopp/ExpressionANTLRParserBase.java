...
public abstract class ExpressionANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements org.emftext.term.propositional.expression.resource.expression.IExpressionTextParser {
	...
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, org.emftext.term.propositional.expression.resource.expression.grammar.ExpressionSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof org.emftext.term.propositional.expression.resource.expression.grammar.ExpressionPlaceholder;
		isElementToStore |= syntaxElement instanceof org.emftext.term.propositional.expression.resource.expression.grammar.ExpressionKeyword;
		isElementToStore |= syntaxElement instanceof org.emftext.term.propositional.expression.resource.expression.grammar.ExpressionEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof org.emftext.term.propositional.expression.resource.expression.grammar.ExpressionBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
	...
	protected <ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> void registerContextDependentProxy(final org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final org.eclipse.emf.ecore.EReference reference, final String id, final org.eclipse.emf.ecore.EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected String formatTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = org.emftext.term.propositional.expression.resource.expression.util.ExpressionStringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(org.emftext.term.propositional.expression.resource.expression.IExpressionOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(org.emftext.term.propositional.expression.resource.expression.IExpressionOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
	...
	protected void addMapEntry(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof org.eclipse.emf.common.util.EMap<?, ?>) {
			org.eclipse.emf.common.util.EMap<Object, Object> valueMap = org.emftext.term.propositional.expression.resource.expression.util.ExpressionMapUtil.castToEMap(value);
	...
	protected org.eclipse.emf.ecore.EObject apply(org.eclipse.emf.ecore.EObject target, java.util.List<org.eclipse.emf.ecore.EObject> dummyEObjects) {
		...
		for (org.eclipse.emf.ecore.EObject object : dummyEObjects) {
			assert(object instanceof org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionDummyEObject);
			org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionDummyEObject dummy = (org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionDummyEObject) object;
	...
	protected org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionTokenResolveResult getFreshTokenResolveResult() {
