 ...
 */
public class ExpressionRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
