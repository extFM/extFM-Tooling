 ...
 */
public class ExpressionEObjectUtil {
	...
	public static Object invokeOperation(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EOperation o) {
		...
		try {
			...
			new org.emftext.term.propositional.expression.resource.expression.util.ExpressionRuntimeUtil().logError("Exception while matching proxy URI.", e);
