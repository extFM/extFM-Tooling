 ...
 * to 4 bytes).
 */
public class ExpressionUnicodeConverter extends org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionInputStreamProcessor {
	 ...
	 */
	public ExpressionUnicodeConverter(java.io.InputStream inputStream) {
