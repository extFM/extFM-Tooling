 ...
 * contains
 * <code>org.emftext.term.propositional.expression.resource.expression.IExpressionT
 * extDiagnostic</code>s it uses the more precise information of this extended
 * diagnostic type.
 */
public class ExpressionMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.term.propositional.expression.resource.expression.IExpressionCommand<Object>> commands = new java.util.ArrayList<org.emftext.term.propositional.expression.resource.expression.IExpressionCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.emftext.term.propositional.expression.resource.expression.IExpressionCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.emftext.term.propositional.expression.resource.expression.IExpressionCommand<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.term.propositional.expression.resource.expression.IExpressionCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.emftext.term.propositional.expression.resource.expression.IExpressionCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.term.propositional.expression.resource.expression.IExpressionTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.term.propositional.expression.resource.expression.IExpressionTextDiagnostic diagnostic) {
		final org.emftext.term.propositional.expression.resource.expression.IExpressionProblem problem = diagnostic.getProblem();
		org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.term.propositional.expression.resource.expression.IExpressionCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemSeverity.ERROR) {
					...
					org.emftext.term.propositional.expression.resource.expression.IExpressionTextDiagnostic textDiagnostic = (org.emftext.term.propositional.expression.resource.expression.IExpressionTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.term.propositional.expression.resource.expression.IExpressionQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.term.propositional.expression.resource.expression.util.ExpressionStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemType nextType : org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.emftext.term.propositional.expression.resource.expression.util.ExpressionRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.emftext.term.propositional.expression.resource.expression.IExpressionCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
