...
public class ExpressionBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		if (builder.isBuildingNeeded(uri)) {
			org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionResource customResource = (org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionResource) resourceSet.getResource(uri, true);
	...
	public String getBuilderMarkerId() {
		return new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionMarkerHelper().getMarkerID(org.emftext.term.propositional.expression.resource.expression.ExpressionEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionTaskItemBuilder taskItemBuilder = new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionTaskItemBuilder();
		new org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
