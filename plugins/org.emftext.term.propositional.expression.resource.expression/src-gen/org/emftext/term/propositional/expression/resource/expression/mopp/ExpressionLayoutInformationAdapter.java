...
/**
 * A ExpressionLayoutInformationAdapter is used to store layout information that
 ...
 * ExpressionLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 */
public class ExpressionLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionLayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionLayoutInformation>();
	...
	public java.util.List<org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.term.propositional.expression.resource.expression.mopp.ExpressionLayoutInformation layoutInformation) {
