 ...
 * 
 */
package org.js.model.rbac.resource.rbactext.launch;

/**
 * A class that handles launch configurations.
 */
public class RbactextLaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new org.js.model.rbac.resource.rbactext.launch.RbactextLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
