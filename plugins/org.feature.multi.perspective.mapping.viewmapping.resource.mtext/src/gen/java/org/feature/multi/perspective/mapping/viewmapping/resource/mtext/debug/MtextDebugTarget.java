...
public class MtextDebugTarget extends org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugElement implements org.eclipse.debug.core.model.IDebugTarget, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.IMtextDebugEventListener {
	
	/**
	 * associated system process
	 */
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugProcess process;
	...
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.IMtextDebugEventListener> eventListeners = new java.util.ArrayList<org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.IMtextDebugEventListener>();
	
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextMetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.IMtextDebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public MtextDebugTarget(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.IMtextDebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.IMtextDebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextMetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextLineBreakpoint lineBreakpoint = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextLineBreakpoint) breakpoint;
	...
	public org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugProxy getDebugProxy() {
