 ...
 */
public class MtextDebuggableInterpreter<ResultType, ContextType> extends org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.AbstractMtextDebuggable {
	
	/**
	 * The actual interpreter. Interpretation is delegated to this object.
	 */
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.AbstractMtextInterpreter<ResultType, ContextType> interpreterDelegate;
	
	/**
	 * To check whether we must stop the execution after step over/into/return, we use
	 * a closure
	 */
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextCommand<org.eclipse.emf.ecore.EObject> stopCondition;
	...
	public MtextDebuggableInterpreter(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.AbstractMtextInterpreter<ResultType, ContextType> interpreterDelegate, int eventPort) {
		this.eventPort = eventPort;
		this.interpreterDelegate = interpreterDelegate;
		this.interpreterDelegate.addListener(new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextInterpreterListener() {
	...
	public org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.AbstractMtextInterpreter<ResultType, ContextType> getInterpreterDelegate() {
		return interpreterDelegate;
	}
	
	private int getLine(org.eclipse.emf.ecore.EObject element) {
		int line = -1;
		org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextLocationMap locationMap = getLocationMap(element);
		if (locationMap != null) {
	...
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextLocationMap getLocationMap(org.eclipse.emf.ecore.EObject element) {
	...
	private void evaluateStep(org.eclipse.emf.ecore.EObject element) {
		...
		org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextCommand<org.eclipse.emf.ecore.EObject> stopCheck = stopCondition;
		if (stopCheck != null && stopCheck.execute(element)) {
			stopCondition = null;
			// suspending after step...
			setSuspend(true);
			sendEvent(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.EMtextDebugMessageTypes.SUSPENDED, true);
			return;
		}
		waitIfSuspended();
	}
	...
	public void stepOver() {
		...
		final int currentLevel = org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextEObjectUtil.getDepth(current);
		stopCondition = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
				...
				int depth = org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextEObjectUtil.getDepth(element);
	...
	public void stepReturn() {
		...
		final int parentLevel = org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextEObjectUtil.getDepth(current) - 1;
		stopCondition = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
