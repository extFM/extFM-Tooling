 ...
 */
public class MtextDefaultTokenResolver implements org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTokenResolver {
	 ...
	 */
	public MtextDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public MtextDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.feature.multi.perspective.mapping.viewmapping.resource.mtext.grammar.MtextGrammarInformationProvider.INSTANCE.getKeywords()) {
