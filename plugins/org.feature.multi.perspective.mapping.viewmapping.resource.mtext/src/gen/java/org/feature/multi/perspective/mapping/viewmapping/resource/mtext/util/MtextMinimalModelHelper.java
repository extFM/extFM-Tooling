 ...
 */
public class MtextMinimalModelHelper {
	
	private final static org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextEClassUtil eClassUtil = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextListUtil.castListUnchecked(value);
