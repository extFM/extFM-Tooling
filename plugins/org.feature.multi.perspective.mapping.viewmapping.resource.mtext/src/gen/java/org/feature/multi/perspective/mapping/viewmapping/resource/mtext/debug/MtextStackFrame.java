...
public class MtextStackFrame extends org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugTarget target;
	private String name;
	private int id;
	...
	public MtextStackFrame(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextStringUtil.decode(data, ',');
	...
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextStackFrame other = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextStackFrame) obj;
		if (name == null) {
