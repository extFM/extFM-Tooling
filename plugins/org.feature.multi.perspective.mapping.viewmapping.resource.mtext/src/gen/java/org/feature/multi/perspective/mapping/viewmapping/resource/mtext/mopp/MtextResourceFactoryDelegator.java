...
public class MtextResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public MtextResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextResourceFactory());
		}
	}
