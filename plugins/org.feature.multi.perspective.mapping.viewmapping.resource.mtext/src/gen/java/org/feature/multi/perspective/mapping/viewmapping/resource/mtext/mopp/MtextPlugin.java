 ...
 */
public class MtextPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.feature.multi.perspective.mapping.viewmapping.resource.mtext";
	/**
	...
	private static MtextPlugin plugin;
	...
	public static MtextPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, MtextPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, MtextPlugin.PLUGIN_ID, message);
		}
		final MtextPlugin pluginInstance = MtextPlugin.getDefault();
