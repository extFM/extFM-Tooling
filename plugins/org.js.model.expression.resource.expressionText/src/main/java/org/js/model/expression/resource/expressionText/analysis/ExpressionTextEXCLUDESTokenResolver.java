...
public class ExpressionTextEXCLUDESTokenResolver implements org.js.model.expression.resource.expressionText.IExpressionTextTokenResolver {
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.js.model.expression.resource.expressionText.IExpressionTextTokenResolveResult result) {
		...
		defaultTokenResolver.resolve(lexem, feature, result, null, null, null);   //ORIGINAL
		// defaultTokenResolver.resolve(lexem, null, result);  //TEST
	}
