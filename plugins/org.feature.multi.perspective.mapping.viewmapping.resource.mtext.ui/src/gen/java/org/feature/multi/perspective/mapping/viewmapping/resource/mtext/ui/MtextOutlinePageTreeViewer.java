 ...
 * a specified depth.
 */
public class MtextOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public MtextOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextPlugin.logError("Exception while refreshing outline view", e);
		}
	}
