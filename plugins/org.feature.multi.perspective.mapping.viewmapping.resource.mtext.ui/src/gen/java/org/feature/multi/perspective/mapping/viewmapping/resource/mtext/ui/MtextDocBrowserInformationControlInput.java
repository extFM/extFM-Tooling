 ...
 * olInput</code>.
 */
public class MtextDocBrowserInformationControlInput {
	
	private final MtextDocBrowserInformationControlInput fPrevious;
	private MtextDocBrowserInformationControlInput fNext;
	 ...
	 */
	public MtextDocBrowserInformationControlInput(MtextDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public MtextDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public MtextDocBrowserInformationControlInput getNext() {
		return fNext;
	}
