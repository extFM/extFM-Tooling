 ...
 */
public class MtextTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput infoInput = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextHyperlink hyperlink = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBrowserInformationControl iControl = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput) {
							org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput input = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBrowserInformationControl.isAvailable(parent)) {
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBrowserInformationControl iControl = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public MtextTextHover(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextHTMLPrinter.insertPageProlog(buffer, 0, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextTextHover.getStyleSheet());
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextHTMLPrinter.addPageEpilog(buffer);
			return new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.feature.multi.perspective.mapping.viewmapping.resource.mtext.util.MtextStreamUtil.getContent(styleSheetURL.openStream());
