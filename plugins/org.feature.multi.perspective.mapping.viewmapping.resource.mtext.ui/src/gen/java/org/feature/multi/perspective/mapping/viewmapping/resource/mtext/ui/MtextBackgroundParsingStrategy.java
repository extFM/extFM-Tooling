 ...
 */
public class MtextBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource resource, final org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource resource, final org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource resource, final org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextResource) {
							org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextResource concreteResource = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextResource) resource;
