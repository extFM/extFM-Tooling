 ...
 */
public class MtextUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui";
	public static final String EDITOR_ID = "org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor";
	...
	private static MtextUIPlugin plugin;
	
	public MtextUIPlugin() {
		super();
	}
	...
	public static MtextUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MtextUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MtextUIPlugin.PLUGIN_ID, message);
		}
		final MtextUIPlugin pluginInstance = MtextUIPlugin.getDefault();
