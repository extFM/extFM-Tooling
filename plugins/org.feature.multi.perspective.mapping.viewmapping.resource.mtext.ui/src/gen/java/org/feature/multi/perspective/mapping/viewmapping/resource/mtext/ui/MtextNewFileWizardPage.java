 ...
 */
public class MtextNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public MtextNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new mtext file");
