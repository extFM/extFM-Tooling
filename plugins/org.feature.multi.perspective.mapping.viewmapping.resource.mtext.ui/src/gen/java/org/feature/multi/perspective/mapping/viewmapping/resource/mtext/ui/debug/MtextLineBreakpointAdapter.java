...
public class MtextLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextPlugin.DEBUG_MODEL_ID);
			...
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextLineBreakpoint lineBreakpoint = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.debug.MtextLineBreakpoint(resource, lineNumber + 1);
