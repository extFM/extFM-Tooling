...
public class MtextBracketSet {
	...
	private java.util.ArrayList<org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair {
	 ...
	 */
	private class ClosingListener implements org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.IMtextBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public MtextBracketSet(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair>();
	 ...
	 */
	public org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair getBracketPair(String opening, String closing) {
		for (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair bracketPair : bracketPairs) {
	...
	public org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair remove(String opening, String closing) {
		for (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
