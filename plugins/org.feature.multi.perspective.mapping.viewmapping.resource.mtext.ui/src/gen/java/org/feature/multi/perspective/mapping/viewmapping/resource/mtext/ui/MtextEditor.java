...
/**
 * A text editor for 'mtext' models.
 * <p>
 * This editor has id
 * <code>org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextE
 * ditor</code>
 * The editor's context menu has id
 * <code>org.feature.multi.perspective.mapping.viewmapping.resource.mtext.EditorCon
 * text</code>.
 * The editor's ruler context menu has id
 * <code>org.feature.multi.perspective.mapping.viewmapping.resource.mtext.EditorRul
 * er</code>.
 * </p>
 */
public class MtextEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextResourceProvider, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.IMtextBracketHandlerProvider, org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.IMtextAnnotationModelProvider {
	
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextCodeFoldingManager codeFoldingManager;
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBackgroundParsingStrategy bgParsingStrategy = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextBackgroundParsingStrategy();
	private java.util.Collection<org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBackgroundParsingListener>();
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextColorManager colorManager = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextColorManager();
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextOutlinePage outlinePage;
	...
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextPropertySheetPage propertySheetPage;
	...
	private org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.IMtextBracketHandler bracketHandler;
	...
	public MtextEditor() {
		super();
		setSourceViewerConfiguration(new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), MtextEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource currentResource = getResource();
				...
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.feature.multi.perspective.mapping.viewmapping.resource.mtext.EditorContext");
		setRulerContextMenuId("org.feature.multi.perspective.mapping.viewmapping.resource.mtext.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.feature.multi.perspective.mapping.viewmapping.resource.mtext.mopp.MtextNature.activate(inputFile.getProject());
		...
		org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource loadedResource = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource) {
					setResource((org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the MtextEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource textResource = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource) element.eResource();
			...
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextToken token = lexer.getNextToken();
			...
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!MtextEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.IMtextBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.IMtextBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource)) {
					return false;
				}
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource textResource = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource) resource;
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
