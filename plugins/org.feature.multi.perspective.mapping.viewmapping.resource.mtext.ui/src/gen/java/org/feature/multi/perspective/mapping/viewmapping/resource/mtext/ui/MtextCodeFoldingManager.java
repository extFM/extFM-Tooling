 ...
 */
public class MtextCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor) {
				org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor editor = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor) workbenchPart;
	...
	protected org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor editor;
	 ...
	 */
	public MtextCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor textEditor) {
	...
	private void addCloseListener(final org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.feature.multi.perspective.mapping.viewmapping.resource.mtext.ui.MtextUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource textResource = (org.feature.multi.perspective.mapping.viewmapping.resource.mtext.IMtextTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
